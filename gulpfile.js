...
exports.default = series(clean, parallel(htmlinclude, scripts, fonts, imgToApp),  fontsStyle, stylesLibs, styles, watchFiles);
...
exports.build = series(clean, parallel(htmlinclude, scriptsBuild, fonts, phpBuild, imgToApp),  fontsStyle, stylesLibs, stylesBuild);